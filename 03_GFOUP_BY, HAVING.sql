...
-- 각 직급별 총사원수, 보너스를 받는 사원 수, 급여합, 평균급여,
-- 최저급여, 최고급여(정렬 : 직급 오름차순)
...
--부서코드가 D5인 사원들의 사번, 이름, 부서코드, 급여조회
SELECT EMP_ID, EMP_NAME, DEPT_CODE, SALARY
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5';
...
--2. INTERSECT(교집합)
--부서코드가 D5이면서 급여도 300만원 초과인 사원들의 사번, 이름, 부서코더, 급여조회
SELECT EMP_ID, EMP_NAME, DEPT_CODE, SALARY
FROM EMPLOYEE
...
--부서코드가 D5인 사원들중 급여가300만원 초과인 사원들을 제외하고 조회
SELECT EMP_ID,EMP_NAME, DEPT_CODE, SALARY
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5'
MINUS
