...
-- 2_2) 제약조건 삭제 : DROP CONSTRANIT 제약조건명 / NOT NULL -> 삭제안됨
...
--3)1 컬럼명 변경 : RENAME COLUMN 기존컬럼명 TO 바꾸 컬럼명
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007312 TO DTABLE_LID_NN;
