...
/*
    1.테이블 생성
    -테이블이란 : 행과 열로 구성되는 가장 기본적인 데이터베이스 규칙
    ...
    *자료형
    -문자(CHAR(바이트크기) | VARCHAR2(바이트크기))
         ...
         (지정한 크기보다 더 작은 값이 들어오면 공백으로라도 채워서 처음 지정한 크기르 만들어준다.)
...
--INSERT INTO 테이블명 VALUES(값,값,값,값,값,값,값,값)
INSERT INTO MEMBER 
VALUES(1, 'USER1`', 'PASS1', '김효영', '남', '010-8589-0930', 'AAAA@GMAIL.COM', '24/02/23');

SELECT * FROM MEMBER;
INSERT INTO MEMBER
VALUES(2, 'USER2`', 'PASS2', '홍길동', '여', '010-5468-7777', 'BBBB@GMAIL.COM', SYSDATE);
...
VALUES(1, 'USER1`', 'PASS1', '김효영', '남', '010-8589-0930', 'AAAA@GMAIL.COM');
...
INSERT INTO MEM_UNIQUE
VALUES(2, 'USER1`', 'PASS2', '김요염', '여', '010-8589-0930', 'AAAA@GMAIL.COM');
...
INSERT INTO MEM_UNIQUE
VALUES(2, 'USER2', 'PASS2', '김요염', '여', '010-8589-0930', 'AAAA@GMAIL.COM');

INSERT INTO MEM_UNIQUE
VALUES(2, 'USER2', NULL, '김요염', '여', '010-8589-0930', 'AAAA@GMAIL.COM');

INSERT INTO MEM_UNIQUE
VALUES(3, 'USER3`', 'PASS3', '홍길동',NULL , '010-8589-0930', 'AAAA@GMAIL.COM');

INSERT INTO MEM_UNIQUE
VALUES(4, 'USER4`', 'PASS4', '이름', '여', '010-8589-0930', 'AAAA@GMAIL.COM');
...
INSERT INTO MEM_CHECK
VALUES(2, 'USER2`', 'PASS2', '김요염', NULL, NULL,NULL);
...
/*
    ...
    테이블에서 각 행(ROW)을 식별하기 위해 사용될 컬럼에 부여하는 제약조건(식별자)
    
    EC) 회원번호, 학번, 군번, 부서코드, 직급코드, 주문번호, 택배운송장번호, 예약번호 등등....
...
INSERT INTO MEM_PRI
VALUES(1, 'USER2`', 'PASS2', '김요염', '여', '010-8589-0930', 'AAAA@GMAIL.COM');
--> 기본키에 중복값을 담으려고 할 때 (UNIQUE제약조건 위반)

INSERT INTO MEM_PRI
VALUES(NULL, 'USER2`', 'PASS2', '김요염', '여', '010-8589-0930', 'AAAA@GMAIL.COM');
...
INSERT INTO MEM_PRI2 VALUES(1,'USER2','PASS2','홍길동',NULL,NULL,NULL);
INSERT INTO MEM_PRI2 VALUES(2,'USER3','PASS3','홍길동',NULL,NULL,NULL);
...
/*
    *FOREIGN KEY(외래키) 제약조건
    ...
    -> 다른테이블을 참조한다고 표현
    -> 주로 FOREIGN KEY 제약조건으로 인해서 테이블관계가 형성된다.
...
CREATE TABLE MEM(
    ...
    --FOREIGN KEY(GRADE_ID)REFERENCES MEM_GRADE(MEM_CODE)
);

INSERT INTO MEM VALUES (1, 'USER1', 'PASS01', '홍길순', '여', NULL, NULL, NULL);
-->외래키 제약조건이 부여된 컬럼에 기본적으로 NULL가능
INSERT INTO MEM VALUES (2, 'USER2', 'PASS01', '홍길순', '여', NULL, NULL, 10);
INSERT INTO MEM VALUES (3, 'USER3', 'PASS03', '최지원', NULL, NULL, NULL, 40);
--> parent key를 찾을 수 없다는 오류 발생

SELECT* FROM MEM;
--MEM)GRADE(부모테이블) -|-------<-ㅡMEM(자식테이블)
--      1:N관계 1쪽이 부모테이블 N이 자식테이블
INSERT INTO MEM VALUES (3, 'USER3', 'PASS03', '홍길순', '여', NULL, NULL, 20);
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = '10';
--> 잘 삭제가 완료됨, 10을 가져다 쓰고있던 자식데이터의 값은 NULL은 변경됨
...
INSERT INTO MEMBER VALUES(3, '김효영', 22 ,DEFAULT , DEFAULT);
SELECT * FROM MEMBER;

--INSERT INTO MEMBER (컬럼1, 컬럼2 ...) VALUAS(컬럼1값, 컬럼2값...);
INSERT INTO MEMBER(MEM_NO, MEM_NAME) VALUES(4, '김효영');
...
/*
    *테이블이 다 생성된 후에 뒤늦게 제약조건을 추가하는 방법
    ...
    -FOREIGN KEY : ALTER TABLE 테이블명 ADD FORIGN KEY(컬럼명) REFERENCES 참조할 테이블명 [(참조할 컬럼명)]
    -UNIQUE      : ALTER TABLE 테이블명 ADD UNIQUE(컬럼명);
    -CHECK       : ALTER TABLE 테이블명 ADD CHECK(컬럼에 대한 조건식);
    -NOT NULL    : ALTER TABLE 테이블명 MODIFY 컬럼명 NOT NULL;
*/

--EMPLOYEE_COPY테이블에 PRIBARY_KEY 제약조건을 추가(EMP_ID)
