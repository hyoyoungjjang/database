/*
    ...
    DDL (DEFINITON데이터 정의) : CREATE, ALTER, DROP
...
INSERT INTO EMPLOYEE VALUES (900,'김효영', '030930-3010615', 'KHY20030930@GMAIL.OCM', '01085890930',
...
SET SALARY = 7000000,
    BONUS = 0.2
WHERE EMP_NAME = '선동일';
--전체 사원의 급여를 기존 급여에 10프로 인상된 급액으로 변경 (기존급여 *1.1)
UPDATE EMP_SALARY
...
--방명수 사원의 급여와 보너스값을 유재식 사원의 급여와 보너스 갑승로 변경
UPDATE EMP_SALARY
